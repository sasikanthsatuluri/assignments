...
Addition        :   Usecase: 2 + 3 = 5   Scenarios :  2 + 3 + 6 = 11 
                                                         -2 + 5 = 3
                                                         addition : adding any two or more numbers
                                                         example : 2 + 2 = 4, 3 + 3 + 3 = 9

Subtraction     :   2 - 3 = -1
                   -2 - 5 = -7
subtraction : subtracting any two numbers
  example : 8 - 7 =1, -10 -1 = -11
Multiplication  :   2 X 3 = 6
                   -5 X 3 = -15
                   multiplication : product of any two or more numbers
                   example : 4 x 3 = 12 ,
                              3 x 3 = 9
Division        :   21 / 4 = quotient 5,remainder 1
                   -20 / 3 = quotient -6, remainder -2
                    division is the process of dividing any two numbers
                    example : 10/2 leaves remainder 0 and quotient 5
                              

BODMAS Principle: BODMAS rule is an acronym that is used to remember the order of operations to be followed while solving expressions in mathematics. 
